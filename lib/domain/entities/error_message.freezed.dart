...
abstract class $ErrorMessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'detail') String error});
}
...
class _$ErrorMessageImpl implements _ErrorMessage {
  _$ErrorMessageImpl({@JsonKey(name: 'detail') required this.error});
...
abstract class _ErrorMessage implements ErrorMessage {
  factory _ErrorMessage(
          {@JsonKey(name: 'detail') required final String error}) =
      _$ErrorMessageImpl;
