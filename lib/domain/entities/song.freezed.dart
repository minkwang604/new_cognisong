...
class _$SongImpl implements _Song {
  ...
  @override
  String toString() {
    return 'Song(id: $id, url: $url, vttUrl: $vttUrl, mrUrl: $mrUrl)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, url, vttUrl, mrUrl);
...
abstract class _Song implements Song {
  factory _Song(
      ...
      @JsonKey(name: 'mr_url') required final String mrUrl}) = _$SongImpl;
